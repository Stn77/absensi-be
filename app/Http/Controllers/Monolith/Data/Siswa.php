...
class Siswa extends Controller
{
    ...
    public function index()
    {
        $jurusan = Jurusan::all();
        $kelas = Kelas::all();
        return view('data.akun-siswa', compact('jurusan', 'kelas'));
    }

    public function getData()
    {
        $data = User::role('siswa')->with('siswa', 'siswa.kelas', 'siswa.jurusan')->get();
    ...
    {
        $siswa = ModelsSiswa::with('user')->find($id);
    ...
    public function update(Request $request)
    {
        try{
            ...
            $siswa = ModelsSiswa::with('user')->find($request->idSiswa);
    ...
    {
        $imageUrl = '';
        $data = ModelsSiswa::with('user', 'kelas', 'jurusan')->find($id);
